...
```{r}
training_signif <- training %>% subset(select = -c(Departure.Delay, Baggage.Handling, 
...
The new model with high information value variables shows a significant decrease in AIC value to 65522 This indicates that the model with high information value variables is better than the base model. The accuracy, sensitivity, and specificity values are also higher than the base model. This shows that the new model is probably better than the base model.
