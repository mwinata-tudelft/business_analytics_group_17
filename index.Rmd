...
We can identify that from the first time customer, the services that dissapointing them most in **Departure and Arrival Time Convenience, Ease of Online Booking, and Wifi Service**.While **In fligth service and comfortability** having the highest satisfaction value. <br>
...
Afterwards, we will split the dataset into training and testing data.In this case we use 0.7 as the proportion of training data.  
...
=======
>>>>>>> f23ae0c91ca340c8b9117652e9ca8e8f77d13f79
...
For **Type of Travel**, high satisfaction is driven by business travelers who value efficiency and convenience, particularly through services like online boarding, check-in service, and baggage handling. In contrast, low satisfaction among personal travelers stems from a focus on comfort and accessibility, with preferences for in-flight WiFi service, ease of online booking, and flight entertainment.<br><br>

For **Class**, high satisfaction is prominent among Business Class customers who emphasize seamless travel experiences, prioritizing online boarding, departure and arrival time convenience, and check-in service. On the other hand, low satisfaction in Economy and Economy Plus passengers highlights their need for enjoyable and accessible features, such as in-flight WiFi service, baggage handling, and ease of online booking.<br><br>
